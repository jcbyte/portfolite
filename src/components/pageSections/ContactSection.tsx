	...
	return (
		<div className="bg-zinc-900 flex flex-col justify-center items-center p-4 gap-2">
			...
			<div className="p-2 flex gap-2 justify-center items-center">
				<IconLink link="mailto:joelcutler108@gmail.com" Icon={IconMail} />
				<IconLink link="https://www.instagram.com/joelcutler7/" Icon={IconBrandInstagram} />
				<IconLink link="https://github.com/jcbyte" Icon={IconBrandGithub} />
				<IconLink link="https://www.linkedin.com/in/joelcutler/" Icon={IconBrandLinkedin} />
			</div>
		</div>
	);
}
