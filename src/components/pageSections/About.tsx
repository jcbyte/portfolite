...
export default function About() {
	return (
		<div className="p-4 bg-char rounded-lg h-[24rem] flex flex-col justify-center items-center gap-4 bg-zinc-800/25">
			<div className="text-5xl">About Me</div>
			<div className="text-xl max-w-[46rem] text-center">
